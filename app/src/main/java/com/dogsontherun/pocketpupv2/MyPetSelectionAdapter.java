...
/**
 * Created by Stelzy on 5/29/2015.
 */
public class MyPetSelectionAdapter extends ArrayAdapter<ParseObject> {

    protected Context mContext;
    protected List mPets;

    public MyPetSelectionAdapter(Context context, List pets) {
        super(context, R.layout.mypetsselectioncustomlayout, pets);
        mContext = context;
        mPets = pets;
    }
